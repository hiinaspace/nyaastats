...
def test_get_schedule_summary(scheduler):
    ...
    torrents = [
        ('abcdef1234567890abcdef1234567890abcdef12', base_time - timedelta(hours=1)),  # hourly
        ('fedcba0987654321fedcba0987654321fedcba09', base_time - timedelta(days=5)),   # every_4_hours
        ('123456789abcdef0123456789abcdef012345678', base_time - timedelta(days=20)),  # daily
        ('876543210fedcba9876543210fedcba987654321', base_time - timedelta(days=120)), # weekly
        ('abcdef9876543210abcdef9876543210abcdef98', base_time - timedelta(days=200))  # never
    ]
